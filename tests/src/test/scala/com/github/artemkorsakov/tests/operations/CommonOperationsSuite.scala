...
class CommonOperationsSuite extends AnyFunSuiteLike {
  ...
  test("allSquares") {
    allSquares(2) shouldBe IndexedSeq(16, 25, 36, 49, 64, 81)
    allSquares(4) shouldBe IndexedSeq(1024, 1089, 1156, 1225, 1296, 1369, 1444, 1521, 1600, 1681, 1764, 1849, 1936,
    ...
    allSquares(36, 49) shouldBe IndexedSeq(36, 49)
    allSquares(1023, 1445) shouldBe IndexedSeq(1024, 1089, 1156, 1225, 1296, 1369, 1444)
    allSquares(1024, 1444) shouldBe IndexedSeq(1024, 1089, 1156, 1225, 1296, 1369, 1444)
    allSquares(1025, 1443) shouldBe IndexedSeq(1089, 1156, 1225, 1296, 1369)
  }
